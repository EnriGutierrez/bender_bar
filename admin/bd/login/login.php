...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty(trim($_POST["user_login"]))) {
    $user_login_err = "Por favor ingrese su nombre de usuario o una identificación de correo electrónico.";
  } else {
    $user_login = trim($_POST["user_login"]);
  }

  if (empty(trim($_POST["user_password"]))) {
    $user_password_err = "Por favor, introduzca su contraseña.";
  } else {
        ...
        if (mysqli_stmt_num_rows($stmt) == 1) {
          ...
          if (mysqli_stmt_fetch($stmt)) {
            ...
            if (password_verify($user_password, $hashed_password)) {
              ...
              $login_err = "El email o la contraseña son incorrectos.";
            }
          }
        } else {
    ...
    <div class="row min-vh-100 justify-content-center align-items-center">
      <div class="col-lg-5">
        ...
        <div class="form-wrap border rounded p-4">
          <h1>Log In</h1>
          <p>Por favor inicie sesión para continua</p>
          <!-- form starts here -->
